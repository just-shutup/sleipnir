...
./sleipnir scan 127.0.0.1 -p 2101,2102,2201,2375,2501,2502,2503,6380,8080,8081,8082,8083,8443
```
...
libs/sleipnir/
  ...
  src/crawler.cpp/.hpp        Веб-краулер и активные пробы приложения (XSS/CSRF/traversal/redirect)
